<%@ page import="Model_Table.TbUser" %>
...
<body>
	<%
		ArrayList<TbUser> users= (ArrayList<TbUser>) request.getAttribute("users");
	%>
	<div id="wrapper">
									...
									<table class="table table-striped table-bordered table-hover"
										...
										<tbody>
											<c:forEach items="${users }" var="user">
												<tr class="odd gradeX">
													<td>${user.getId() }</td>
													<c:url value="/image?fname=${user.getAvatar()}" var="imgUrl"></c:url>

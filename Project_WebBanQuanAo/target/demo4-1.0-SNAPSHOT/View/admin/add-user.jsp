						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-6">
									...
									<form role="form" action="add"  method="get" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<input class="form-control" placeholder="please enter password" type="textbox"
												   name="password" />
										</div>
										...
										<div class="form-group">
											...
											<input class="form-control" type="textbox" placeholder="Please enter address" name="address" />
										</div>
